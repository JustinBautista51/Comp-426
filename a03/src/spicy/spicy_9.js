...
//console.log(repeat(bob, 10, [9, 10]))
...
export const multiplyBy = (num1) => {
    let answer = function multiply(num2) {
        return num1 * num2
    }
    return answer;
...
export const everyEven = (arr, test) => {
    ...
    for (let i = 0; i < arr.length; i++) {
        results[i] = test(arr[i])
    }
    for (let j = 0; j < results.length; j = j + 2) {
        if (results[j] == false) {
            return false;
        }
    }
...
export const allEvensAreOdd = (arr) => {
    return everyEven(arr, isItOdd)
};
console.log(allEvensAreOdd([1, 0, 1, 0, 1, 0]))
console.log(allEvensAreOdd([1, 0, 1, 0, 0, 1]))
...
export const anEvenIsOdd = (arr) => {
    return someEven(arr, isItOdd)
};
console.log(anEvenIsOdd([0, 0, 0, 0, 1, 0]))
console.log(anEvenIsOdd([0, 0, 0, 0, 0, 0]))
